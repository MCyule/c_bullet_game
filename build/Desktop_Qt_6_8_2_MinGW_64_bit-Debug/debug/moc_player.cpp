...
Q_CONSTINIT static const uint qt_meta_data_ZN6PlayerE[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QVector2D,    2,
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->manaChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->shooted((*reinterpret_cast< std::add_pointer_t<QVector2D>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Player::*)(int );
            if (_q_method_type _q_method = &Player::manaChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Player::*)(QVector2D );
            if (_q_method_type _q_method = &Player::shooted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Player::manaChanged(int _t1)
{
...
// SIGNAL 1
void Player::shooted(QVector2D _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
