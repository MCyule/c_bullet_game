...
static constexpr auto qt_meta_stringdata_ZN4CardE = QtMocHelpers::stringData(
    "Card"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4CardE[] = {
...
Q_CONSTINIT const QMetaObject Card::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4CardE.offsetsAndSizes,
    qt_meta_data_ZN4CardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4CardE_t,
        // Q_OBJECT / Q_GADGET
...
void *Card::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4CardE.stringdata0))
